package com.example.a31_jsonclima_erick;
...
public class MainActivity extends AppCompatActivity implements AsyncResponse  {
    ...
    TextView clima1,clima2,climat, cd;
    Button buscar;
    ...
    public void CargarClima() {
        try {
            ...
            String ciudad = "http://api.openweathermap.org/data/2.5/weather?q="+cd.getText().toString()+",mx&APPID=5a8ab31167d55aa3d4970b6ea03aa2bd";
            URL direcciopn = new URL(ciudad);
