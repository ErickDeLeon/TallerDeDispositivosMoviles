...
public class MenuAlumno extends AppCompatActivity  implements AsyncResponse {
    ...
    String nombre2;
    String direccion2;
    String url="192.168.137.205";   //por ip local
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("3.4 Servicios Web - CRUD");
                                ...
                                if (Operacion==2) {
                                    try {
                                        ...
                                        if(domicilio.getText().toString().equals("")){
                                            conexionWeb.agregarVariable("domicilio"," ");
                                        }else {
